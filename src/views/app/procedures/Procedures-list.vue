  ...
  <div>
    <Card noborder>
      ...
      >
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-5">
          ...
          <Textinput
            label="Price"
            type="number"
            v-model="currentProcedure.Price"
      ...
      <vue-good-table
        ...
        :rows="this.$store.state.procedure.procedures"
        :pagination-options="{
          enabled: true,
          perPage: perpage,
        }"
      ...
      >
        ...
        <template #pagination-bottom="props">
          <div class="py-4 px-3 justify-center flex">
            <Pagination
              :total="$store.state.procedure.procedures.length"
              :current="current"
              :per-page="perpage"
              :pageRange="pageRange"
...
export default {
      ...
      actions: [
        ...
        },
        {
          ...
          doit: (data) => {
            ...
            this.$store.dispatch('deleteProcedure', data)
            .then(response => {
  ...
  methods: {
    updateProcedure(){
      const toast = useToast();
      this.$store.dispatch('updateProcedure', this.currentProcedure)
      .then(response => {
